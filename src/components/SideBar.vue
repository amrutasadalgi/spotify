<template>
  <v-container class="ma-0 pa-0" style="max-width: 100%">
    <v-col cols="2" class="pa-0 ma-0" style="position: fixed; ">
      <v-row class="black py-5 ma-0">
        <svg
          viewBox="-10 0 130 20"
      ...
      <v-row class="black pa-0 ma-0">
        <v-list class="black">
          ...
          <v-list-item class="white--text"
            ...
            <v-list-item-content>
              <v-list-item-title>Your Library</v-list-item-title>
            </v-list-item-content></v-list-item
          >
        </v-list>
      </v-row>
      ...
      <v-row class="black pa-0 ma-0">
        <v-list class="black">
          ...
          <v-list-item class="white--text">
            <v-list-item-content>
              <v-list-item-title>List 3</v-list-item-title>
            </v-list-item-content></v-list-item
          >
          <v-list-item class="white--text">
            <v-list-item-content>
              <v-list-item-title>List 4</v-list-item-title>
            </v-list-item-content></v-list-item
          >
        </v-list>
      </v-row>
    ...
    <v-col cols="12" class="pa-0 ma-0 red" style="height: 150vh;"
      >Main Content</v-col
    >
    <v-col cols="12" class="pa-0 ma-0 green" style="height: 150vh;"
      >Main Content</v-col
    >
  </v-container>
</template>
