<template>
  <v-footer color="black">
    <v-container class="my-16">
      <v-row>
        ...
        <v-col>
          <v-content>
            <v-list color="black">
              <v-list-item dark class="grey--text">
                <a href="" class="grey--text text-decoration-none">COMPANY</a>
              </v-list-item>
              <v-list-item dark>
                <a href="" class="white--text text-decoration-none">About</a>
              </v-list-item>
              <v-list-item dark> <a href="" class="white--text text-decoration-none">Jobs</a> </v-list-item>
              <v-list-item dark><a href="" class="white--text text-decoration-none">For the record</a> </v-list-item>
            </v-list>
          </v-content>
        </v-col>
        <v-col>
          <v-content>
            <v-list color="black">
              <v-list-item dark class="grey--text">
                <a href="" class="grey--text text-decoration-none"
                  >COMMUNITIES</a
                >
              </v-list-item>
              <v-list-item dark> <a href="" class="white--text text-decoration-none">For Artists</a> </v-list-item>
              <v-list-item dark> <a href="" class="white--text text-decoration-none">Developer</a> </v-list-item>
              <v-list-item dark> <a href="" class="white--text text-decoration-none">Advertising</a> </v-list-item>
              <v-list-item dark> <a href="" class="white--text text-decoration-none">Investor</a> </v-list-item>
              <v-list-item dark> <a href="" class="white--text text-decoration-none">Vendors</a> </v-list-item></v-list
            >
          </v-content>
        </v-col>
        <v-col>
          <v-content>
            <v-list color="black">
              ...
              <v-list-item dark> <a href="" class="white--text text-decoration-none">Support</a> </v-list-item>
              <v-list-item dark> <a href="" class="white--text text-decoration-none">Web Player</a> </v-list-item>
              <v-list-item dark> <a href="" class="white--text text-decoration-none">Free Mobile App</a> </v-list-item>
            </v-list>
          </v-content>
        </v-col>
        <v-col>
    ...
    <v-container class="mb-14">
      <v-row>
        <v-col>
          <v-content class="mr-14">
            <a href="" class="grey--text text-decoration-none pa-4 caption"
              >Legal</a
            >
            <a href="" class="grey--text text-decoration-none pa-4 caption"
              >Privacy Center</a
          ...
          <v-content class="float-right">
            <v-row>
              <v-col>
                ...
                <a href="" class="grey--text text-decoration-none caption pl-1"
                  >India(English)</a
                >
              </v-col>
            </v-row>
            <v-row>
              <a href="" class="grey--text text-decoration-none caption"
                >© 2022 Spotify AB</a
              >
            </v-row>
          </v-content>
