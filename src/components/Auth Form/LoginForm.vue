<template>
  <div>
    <v-container>
      <svg
        viewBox="-130 0 330 20"
        xmlns="http://www.w3.org/2000/svg"
        preserveAspectRatio="xMidYMin meet"
      >
        <g fill="black" class="svelte-1gcdbl9">
          <path
    ...
    <v-container class="mx-16 d-flex grey lighten-5 elevation-4">
      <v-card elevation="0">
        <v-img
          src="https://images.unsplash.com/photo-1588693951525-7b0be0fc710f?crop=entropy&cs=tinysrgb&fm=jpg&ixlib=rb-1.2.1&q=60&raw_url=true&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MjB8fG11c2ljfGVufDB8MXwwfHw%3D&auto=format&fit=crop&w=500"
          max-width="500"
          max-height="500"
          class="ma-5"
        ></v-img>
      </v-card>
      <validation-observer ref="observer" v-slot="{ invalid }" class="ma-5">
        ...
        OR
          ...
          <v-btn class="mr-4" type="submit" :disabled="invalid"> Log-In </v-btn>
